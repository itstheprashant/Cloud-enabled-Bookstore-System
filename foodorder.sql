...
-- INSERT INTO `book` (`F_ID`, `name`, `price`, `description`, `R_ID`, `images_path`, `options`) VALUES
...
-- INSERT INTO `orders` (`order_ID`, `F_ID`, `bookname`, `price`, `quantity`, `order_date`, `username`, `R_ID`) VALUES
...
INSERT INTO `BookStore` (`R_ID`, `name`, `email`, `contact`, `address`, `M_ID`) VALUES
(1, 'Nikhil\'s Bookstore', 'nikhil@Bookstore.com', '7998562145', 'Karnataka', 'aminnikhil073'),
(2, 'Roshan\'s Bookstore', 'roshan@Bookstore.com', '9887546821', 'Bihar', 'roshanraj07'),
(3, 'Aditi\'s Bookstore', 'aditi@Bookstore.com', '7778564231', 'Goa', 'aditi068'),
(4, 'book Exploria', 'ckj40856@gmail.com', '09487810674', 'C:\\xampp\\htdocs\\bookExploria-master\\images/coffee.', 'ckumar'),
...
--
ALTER TABLE `book`
  ADD CONSTRAINT `book_ibfk_1` FOREIGN KEY (`R_ID`) REFERENCES `BookStore` (`R_ID`);

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`F_ID`) REFERENCES `book` (`F_ID`),
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`username`) REFERENCES `customer` (`username`),
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`R_ID`) REFERENCES `BookStore` (`R_ID`);

--
-- Constraints for table `BookStore`
--
ALTER TABLE `BookStore`
  ADD CONSTRAINT `BookStore_ibfk_1` FOREIGN KEY (`M_ID`) REFERENCES `manager` (`username`);
COMMIT;
