...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $quantity = $values["book_quantity"];
    $price =  $values["book_price"];
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, bookname, price,  quantity, order_date, username, R_ID) 
              VALUES ('" . $F_ID . "','" . $bookname . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $R_ID . "')";
